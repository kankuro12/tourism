...
@endsection
@section('meta')
<meta name="description" content="{{ $chapter->short_desc }}">
@endsection
@section('title')
    Chapter - {{ $chapter->name }}
@endsection
@section('content')
    <section class="page-banner blog-detail" style="background-image: url({{ asset($chapter->image) }})">
        <div class="container">
            <div class="page-title-wrapper">
                <div class="page-title-content">
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="{{ route('chapters') }}" class="link">Chapters</a>
                        </li>
                        <li class="active">
                            <a href="#" class="link">{{ $chapter->name }}</a>
                        </li>
                    </ol>
                    <div class="clearfix"></div>
                    <h1 style="margin-bottom:20px;">{{ $chapter->name }}</h1>
                </div>
            </div>
        </div>
    </section>
