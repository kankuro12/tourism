...
@section('s-title')
    <a href="{{ route('admin.destination.type.index') }}">Destination Types</a> / Add
@endsection

@section('content')
    <form action="{{ route('admin.destination.type.add') }}" enctype="multipart/form-data" method="post">
        @csrf
        <div class="bg-white shadow mb-3">
            <div class="card-body">
                ...
                <div class="form-group">
                    <button class="btn btn-primary">Save Destionation Type</button>
