        ...
        <div class="row">
            ...
            <div class="col-12 py-3">
                <div class="shadow">
                    ...
                    <input type="file" name="slider_image" id="slider_image"  accept="image/*"  class="form-control image" {{$data->slider_image==''?'required':''}} data-default-file="{{asset($data->slider_image)}}">
                </div>
            </div>
            <div class="col-12 py-3">
                <div class="shadow">
                    <label for="map_bg">Map Background (1920 X 1000)</label>
                    <input type="file" name="map_bg" id="map_bg"  accept="image/*"  class="form-control image" {{$data->map_bg==''?'required':''}} data-default-file="{{asset($data->map_bg)}}">
                </div>
            </div>
            <div class="col-12 py-3">
                <div class="shadow">
                    ...
                    <div class="p-2">
                        <div class="row">
                            <div class="col-md-6">
                                <label>Title</label>
                                <input type="text" name="contact_title" id="contact_title" class="form-control" value="{{$data->contact_title}}">
                            </div>
                            <div class="col-md-6">
                                <label>Sub Title</label>
                                <input type="text" name="contact_subtitle" id="contact_subtitle" class="form-control" value="{{$data->contact_subtitle}}">
                            </div>
                            <div class="col-12 ">

                                    <label for="contact_bg">Background(1920 X 1000)</label>
                                    <input type="file" name="contact_bg" id="contact_bg" accept="image/*"  class="form-control image" {{$data->contact_bg==''?'required':''}} data-default-file="{{asset($data->contact_bg)}}">
                            ...
                            <div class="col-12 ">
                                ...
                                <input type="file" name="contact_image" id="contact_image" accept="image/*" class="form-control image" {{$data->contact_image==''?'required':''}} data-default-file="{{asset($data->contact_image)}}">
