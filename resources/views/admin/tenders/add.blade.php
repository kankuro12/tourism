...
@section('s-title')
    <a href="{{ route('admin.tenders.index') }}">Tenders</a> / Add
@endsection

@section('content')
    <form action="{{ route('admin.tenders.add') }}" enctype="multipart/form-data" method="post">
        @csrf
        <div class="bg-white shadow mb-3">
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="file" id="file"  class="form-control image" required>
                </div>
